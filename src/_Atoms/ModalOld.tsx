  ...
  return (
    <div
      className='UShell_Modal fixed top-0 left-0 right-0 bottom-0
        z-40 w-full h-full bg-black bg-transparent1 bg-opacity-50 border-4 border-red-400'
    >
      <div
      ...
      >
        ...
        >
          <div
            className={`USHell_Modal_TopBar w-full border-b dark:border-bg9dark bg-bg1 dark:bg-bg1dark flex whitespace-nowrap items-center px-2`}
          >
