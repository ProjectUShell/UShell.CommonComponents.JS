...
const RelationForm: React.FC<{ relation: RelationSchema; onChange: () => void }> = ({
  relation,
  onChange,
}) => {
  ...
  return (
    <div className='flex flex-col gap-4'>
      <h2 className='border-b text-lg border-bg5 dark:border-bg5dark'>Relation</h2>
      <div className=''>
        <label className='block mb-2 text-xs font-medium'>Foreign Entity Name</label>
        <input
          readOnly
      ...
      <div className=''>
        <label className='block mb-2 text-xs font-medium'>Primary Entity Name</label>
        <input
          readOnly
          className='cursor-default text-sm rounded-md bg-bg2 dark:bg-bg2dark block w-full p-1 outline-none'
          type='text'
      ...
      <div className=''>
        <label className='block mb-2 text-xs font-medium'>Foreign Key Property</label>
        <input
          readOnly
          className='cursor-default text-sm rounded-md bg-bg2 dark:bg-bg2dark block w-full p-1 outline-none'
          type='text'
