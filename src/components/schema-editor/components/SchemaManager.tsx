...
import Table from '../../guifad/_Organisms/Table'
...
const SchemaManager: React.FC<{
  ...
  useEffect(() => {
    schemaProvider.getSchemaNames().then((sn) => setSchemaInfos(sn))
  }, [schemaProvider])
  ...
  if (!schemaInfos) return <LoadingScreen></LoadingScreen>
              ...
              onRenderCell(cellValue) {
                return (
                  <div className='flex justify-between'>
                    ...
                    <button className='hover:bg-bg2 dark:hover:bg-bg2dark px-2'>...</button>
                  </div>
                )
              },
            },
