...
import { EntitySchema, IndexSchema, RelationSchema } from 'fusefx-modeldescription'
...
const IndexForm: React.FC<{
  ...
  return (
    <div className='flex flex-col gap-4'>
      <h2 className='border-b text-lg border-bg5 dark:border-bg5dark'>Index Fields</h2>
